...
where y is stock yield difference, $x_{2}$ is expected real bond rate difference, and $x_{3}$ is nominal bond rate difference. Two regressions are run for both expected real and nominal stock yields as y.
